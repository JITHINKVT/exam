...
mysql_query("update employee set name='$name',phone='$phone',email='$email',gender='$gendr',hobbies='$hobies'country='$contry' where sino=1");
...
<table width="316" border="5" cellspacing="0" cellpadding="0">
  ...
  <tr>
   ...
   <input name="btn" type="submit" value="Update"><br>
